...
public class Contact_us_fragment extends Fragment implements HomeActivity.OnBackPressedListener {
    @Override
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_contact_us_fragment,null);
    }
